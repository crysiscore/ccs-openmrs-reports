...
select  gravidaLactante.patient_id
...
from
    /******    Gravidez    ******************/
     ...
     ( Select p.patient_id, e.encounter_datetime data_gravida
      ...
      where p.voided = 0
        ...
        and e.encounter_datetime between  DATE_SUB(CURRENT_DATE(), INTERVAL 9 MONTH) and current_date
        and e.location_id = (select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
      ...
      where pp.program_id = 8
        and pp.voided = 0
        and pp.date_enrolled between  DATE_SUB(CURRENT_DATE(), INTERVAL 9 MONTH) and current_date
        and pp.location_id = (select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
      ...
      where p.voided = 0
        ...
        and o.value_datetime between  DATE_SUB(CURRENT_DATE(), INTERVAL 9 MONTH) and current_date
        and e.location_id = (select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
      ...
      where p.voided = 0
        ...
        and data_colheita.value_datetime between  DATE_SUB(CURRENT_DATE(), INTERVAL 9 MONTH) and current_date
        and e.location_id = (select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
      ...
      where p.voided = 0
        ...
        and e.encounter_type in (5, 6)
        and e.encounter_datetime between  DATE_SUB(CURRENT_DATE(), INTERVAL 9 MONTH)
          and current_date
        and e.location_id = (select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )) gravida_real
			...
			(
				...
				-- Patients on ART who initiated the ARV DRUGS ART Regimen Start Date
						...
						WHERE 	e.voided=0 AND o.voided=0 AND p.voided=0 AND
								...
								e.encounter_datetime<=current_date AND e.location_id=(select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
						...
						WHERE 	p.voided=0 AND e.voided=0 AND o.voided=0 AND e.encounter_type IN (18,6,9,53) AND
								...
								o.value_datetime<=current_date AND e.location_id=(select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
						GROUP BY p.patient_id
						...
						WHERE 	pg.voided=0 AND p.voided=0 AND program_id=2 AND date_enrolled<=current_date AND location_id=(select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
						...
						/*Patients with first drugs pick up date set in Pharmacy: First ART Start Date*/
						  ...
						  FROM 		patient p
									INNER JOIN encounter e ON p.patient_id=e.patient_id
						  WHERE		p.voided=0 AND e.encounter_type=18 AND e.voided=0 AND e.encounter_datetime<=current_date AND e.location_id=(select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
						  GROUP BY 	p.patient_id
    ...
    where pg.voided = 0
      ...
      and pg.program_id = 8
      and ps.state = 27
      and ps.start_date between  DATE_SUB(CURRENT_DATE(), INTERVAL 9 MONTH) and current_date
      and location_id = (select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )) lactante_real
 ...
 where    ( gravida_real.data_gravida is not null and lactante_real.data_parto is  null ) or (gravida_real.data_gravida is not null and lactante_real.data_parto is not null)
      ...
      group by inicio_real.patient_id
        ...
        LEFT JOIN(
            ...
            FROM ( SELECT e.patient_id, o.value_numeric , encounter_datetime
					FROM encounter e
							INNER JOIN obs o ON o.encounter_id=e.encounter_id
					WHERE 	e.voided=0  AND e.location_id=(select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )  AND
			...
			e.voided=0  AND  e.location_id=(select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )  AND
	...
	(
		...
		where 	pp.program_id=8 and
				pp.date_enrolled between  DATE_SUB(CURRENT_DATE(), INTERVAL 9 MONTH) and current_date and pp.location_id=(select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
    ...
    /* ******************************** ultima carga viral *********** ******************************/
        LEFT JOIN(
          SELECT 	e.patient_id,
				...
				AND	e.voided=0  AND e.location_id= (select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )   AND e.encounter_type IN (6,9,13,53) AND
				o.voided=0 AND 	o.concept_id IN( 856, 1305) /* AND  e.encounter_datetime <= current_date */
...
LEFT JOIN (
	SELECT ultimavisita.patient_id,ultimavisita.encounter_datetime,o.value_datetime,e.location_id,e.encounter_id
		FROM
			...
			e.encounter_type IN (9,6) AND e.location_id=(select location_id from location l where l.name = (select property_value from global_property where property = 'default_location') )
			 GROUP BY e.patient_id
