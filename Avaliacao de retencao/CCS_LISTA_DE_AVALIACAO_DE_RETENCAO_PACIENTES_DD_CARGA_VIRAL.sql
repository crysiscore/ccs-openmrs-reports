...
/*			 pad3.county_district as 'Distrito',
             ...
             inicio_real.carga_viral,
             inicio_real.carga_viral_qualitativa,
          DATE_FORMAT(inicio_real.data_cv, '%d/%m/%Y') as 'data_cv'
      FROM (Select fp_levantamentos.*
            /************************ MDC: FARMAC / Farmácia Privada  165177  **************************/
            from (Select dd.*, cv.carga_viral_qualitativa, cv.carga_viral, cv.data_cv
...
SELECT patient_id, encounter_datetime as data_cv,  				CASE value_coded
                ...
                value_numeric as carga_viral
                                     ...
                                     on cv.patient_id = dd.patient_id) fp_levantamentos
            order by patient_id, data_cv desc) inicio_real
