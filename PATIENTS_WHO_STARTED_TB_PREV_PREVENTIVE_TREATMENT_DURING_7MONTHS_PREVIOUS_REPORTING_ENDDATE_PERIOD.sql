...
from (
   ...
   /*       	   Inicio  3HP na Ficha Clinica, Seguimento e Resumo                          */
		...
		where p.voided=0 and e.voided=0  and profilaxia3HP.voided = 0 and estadoProfilaxia.voided = 0
			...
			and e.encounter_type in (6,9,53) and e.location_id=:location and estadoProfilaxia.obs_datetime between (:endDate - interval 48 month) and :endDate
	...
	/*		        Inicio Usando Outras prescrições DT-3HP na Ficha Clinica                   */
		...
		where p.voided=0 and e.voided=0  and outrasPrescricoesDT3HP.voided=0 and outrasPrescricoesDT3HP.obs_datetime between   (:endDate - interval 48 month)  and :endDate
		...
		where e.voided=0 and p.voided=0 and seguimentoTPT.obs_datetime between  (:endDate - interval 48 month) and :endDate
